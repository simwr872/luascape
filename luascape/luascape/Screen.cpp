...
//
//   FUNCTION: CreateBitmap(const int x, const int y)
//
//   PURPOSE:  Creates a 32bit bitmap.
//
//   COMMENTS:
//
...
//
//   FUNCTION: ReadPixel(const int x, const int y)
//
//   PURPOSE:  Reads a pixel color from the RuneScape client.
//
COLORREF Screen::ReadPixel(const int x, const int y) {
	// Define the bitmap. Since we're reading a pixel
	// we only need a 1x1 bitmap.
