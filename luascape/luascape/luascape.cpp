...
int LuaPress(lua_State *Lua) {
	...
	// |0         |0        |0      |0000    |0       |00011110|0000000000000000|
	// Scan code is generated by hardware (keyboard) and is never used as
	// an key identifier. But to be safe use '00011110' (my keyboard).
